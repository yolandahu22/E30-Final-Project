...
psf_bias = 100  #if PSF needs sensor bias removed, put that here.
...
class solverSettings: 
    ...
    maxIter = 100 #Maximum iteration count  Default: 200
    ...
    def disp_func(self,x):
        return x
    disp_figs = 20 #If set to 0, never display. If set to N>=1, show every N.
