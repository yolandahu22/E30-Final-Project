...
class solverSettings: 
    ...
    maxIter = 50 #Maximum iteration count  Default: 200
    ...
    def disp_func(self,x):
        return x
    disp_figs = 5 #If set to 0, never display. If set to N>=1, show every N.
    print_interval = 10 #Print cost every N iterations. Default 1. If set to 0, don't print.
